...
from electrum_blk.hw_wallet.trezor_qt_pinmatrix import PinMatrixWidget
from electrum_blk.hw_wallet.plugin import only_hook_if_libraries_available, OutdatedHwFirmwareException
