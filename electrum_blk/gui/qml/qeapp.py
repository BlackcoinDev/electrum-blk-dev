...
class ElectrumQmlApplication(QGuiApplication):
    ...
    def __init__(self, args, *, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        qmlRegisterType(QEAmount, 'org.blackcoin', 1, 0, 'Amount')
        qmlRegisterType(QEBytes, 'org.blackcoin', 1, 0, 'Bytes')
        qmlRegisterType(QENewWalletWizard, 'org.blackcoin', 1, 0, 'QNewWalletWizard')
        qmlRegisterType(QETermsOfUseWizard, 'org.blackcoin', 1, 0, 'QTermsOfUseWizard')
        qmlRegisterType(QEServerConnectWizard, 'org.blackcoin', 1, 0, 'QServerConnectWizard')
        qmlRegisterType(QEFilterProxyModel, 'org.blackcoin', 1, 0, 'FilterProxyModel')
        qmlRegisterType(QSortFilterProxyModel, 'org.blackcoin', 1, 0, 'QSortFilterProxyModel')

        qmlRegisterType(QEWallet, 'org.blackcoin', 1, 0, 'Wallet')
        qmlRegisterType(QEBitcoin, 'org.blackcoin', 1, 0, 'Bitcoin')
        qmlRegisterType(QEQRParser, 'org.blackcoin', 1, 0, 'QRParser')
        qmlRegisterType(QEQRScanner, 'org.blackcoin', 1, 0, 'QRScanner')
        qmlRegisterType(QEFX, 'org.blackcoin', 1, 0, 'FX')
        qmlRegisterType(QETxFinalizer, 'org.blackcoin', 1, 0, 'TxFinalizer')
        qmlRegisterType(QEPIResolver, 'org.blackcoin', 1, 0, 'PIResolver')
        qmlRegisterType(QEInvoice, 'org.blackcoin', 1, 0, 'Invoice')
        qmlRegisterType(QEInvoiceParser, 'org.blackcoin', 1, 0, 'InvoiceParser')
        qmlRegisterType(QEAddressDetails, 'org.blackcoin', 1, 0, 'AddressDetails')
        qmlRegisterType(QETxDetails, 'org.blackcoin', 1, 0, 'TxDetails')
        qmlRegisterType(QEChannelOpener, 'org.blackcoin', 1, 0, 'ChannelOpener')
        qmlRegisterType(QELnPaymentDetails, 'org.blackcoin', 1, 0, 'LnPaymentDetails')
        qmlRegisterType(QEChannelDetails, 'org.blackcoin', 1, 0, 'ChannelDetails')
        qmlRegisterType(QESwapHelper, 'org.blackcoin', 1, 0, 'SwapHelper')
        qmlRegisterType(QERequestDetails, 'org.blackcoin', 1, 0, 'RequestDetails')
        qmlRegisterType(QETxRbfFeeBumper, 'org.blackcoin', 1, 0, 'TxRbfFeeBumper')
        qmlRegisterType(QETxCpfpFeeBumper, 'org.blackcoin', 1, 0, 'TxCpfpFeeBumper')
        qmlRegisterType(QETxCanceller, 'org.blackcoin', 1, 0, 'TxCanceller')
        qmlRegisterType(QETxSweepFinalizer, 'org.blackcoin', 1, 0, 'SweepFinalizer')
        qmlRegisterType(QEBip39RecoveryListModel, 'org.blackcoin', 1, 0, 'Bip39RecoveryListModel')
        qmlRegisterType(FeeSlider, 'org.blackcoin', 1, 0, 'FeeSlider')
        # TODO QT6: these were declared as uncreatable, but that doesn't seem to work for pyqt6
        # qmlRegisterUncreatableType(QEAmount, 'org.blackcoin', 1, 0, 'Amount', 'Amount can only be used as property')
        # qmlRegisterUncreatableType(QENewWalletWizard, 'org.blackcoin', 1, 0, 'QNewWalletWizard', 'QNewWalletWizard can only be used as property')
        # qmlRegisterUncreatableType(QEServerConnectWizard, 'org.blackcoin', 1, 0, 'QServerConnectWizard', 'QServerConnectWizard can only be used as property')
        # qmlRegisterUncreatableType(QEFilterProxyModel, 'org.blackcoin', 1, 0, 'FilterProxyModel', 'FilterProxyModel can only be used as property')
        ...
        self.context.setContextProperty('UI_UNIT_NAME', {
            ...
            "FIXED_SAT":             electrum_blk.util.UI_UNIT_NAME_FIXED_SAT,
