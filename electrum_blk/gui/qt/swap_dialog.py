...
from electrum_blk.util import NotEnoughFunds, NoDynamicFeeEstimates, UserCancelled, trigger_callback
from electrum_blk.bitcoin import DummyAddress
from electrum_blk.transaction import PartialTxOutput, PartialTransaction, PartialTxInput
from electrum_blk.fee_policy import FeePolicy
from electrum_blk.submarine_swaps import NostrTransport

from electrum_blk.gui.common_qt.util import QtEventListener, qt_event_listener
...
if TYPE_CHECKING:
    ...
    from electrum_blk.submarine_swaps import SwapServerTransport, SwapOffer
...
class SwapServerDialog(WindowModalDialog, QtEventListener):
    ...
    def update_servers_list(self, servers: Sequence['SwapOffer']):
        ...
        from electrum_blk.util import age
        items = []
        for x in servers:
